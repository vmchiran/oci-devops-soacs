...
resource "oci_identity_compartment" "soacs" {
  ...
  description    = "SOACS compartment created by Terraform"
...
resource "oci_core_service_gateway" "sg" {
  ...
  #Optional
  display_name   = "soa-sg1"
}

resource "oci_core_route_table" "soa_public_route_table" {
  compartment_id = oci_identity_compartment.soacs.id
  vcn_id         = oci_core_vcn.vcn.id
  ...
  #Optional
  display_name = "soa-public-rt1"
}

resource "oci_core_route_table" "soa_private_route_table" {
  compartment_id = oci_identity_compartment.soacs.id
  vcn_id         = oci_core_vcn.vcn.id
...
resource "oci_core_security_list" "soa_bastion_security_list" {
  #Required
  compartment_id = oci_identity_compartment.soacs.id
  vcn_id         = oci_core_vcn.vcn.id

  #Optional
  display_name   = "soa-bastion-sl1"
...
# Security List for the Load Balancer Subnets
resource "oci_core_security_list" "soa_lb_security_list" {
  #Required
  compartment_id = oci_identity_compartment.soacs.id
  vcn_id         = oci_core_vcn.vcn.id

  #Optional
  display_name   = "soa-lb-sl1"
...
resource "oci_core_security_list" "soa_private_security_list" {
  #Required
  compartment_id = oci_identity_compartment.soacs.id
  vcn_id         = oci_core_vcn.vcn.id

  #Optional
  display_name   = "soa-private-sl1"
...
resource "oci_core_subnet" "soa_bastion_subnet" {
  ...
  route_table_id  = oci_core_route_table.soa_public_route_table.id
  # security_list_ids = [oci_core_vcn.vcn.default_security_list_id, oci_core_security_list.security_list.id]
  security_list_ids = [oci_core_security_list.soa_bastion_security_list.id]
}
...
resource "oci_core_subnet" "soa_lb_private_subnet" {
  ...
  route_table_id  = oci_core_route_table.soa_private_route_table.id
  # security_list_ids = [oci_core_vcn.vcn.default_security_list_id, oci_core_security_list.security_list.id]
  security_list_ids = [oci_core_security_list.soa_lb_security_list.id]
}
...
resource "oci_core_subnet" "soa_private_subnet" {
  ...
  route_table_id  = oci_core_route_table.soa_private_route_table.id
  # security_list_ids = [oci_core_vcn.vcn.default_security_list_id, oci_core_security_list.security_list.id]
  security_list_ids = [oci_core_security_list.soa_private_security_list.id]
}
